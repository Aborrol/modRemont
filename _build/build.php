...
class modRemontPackage
{
    ...
    {
        $this->modx->addExtensionPackage('modremont', '[[++core_path]]components/' . $this->config['name_lower'] . '/model/');
        $this->model();
        $this->assets();
...
$install = new modRemontPackage(MODX_CORE_PATH, $config);
